...
class PR2QPControllerConfig(QPControllerConfig):
    def setup(self):
        head_pan_joint: RevoluteConnection = god_map.world.get_connection_by_name(
            "head_pan_joint"
        )
        head_tilt_joint: RevoluteConnection = god_map.world.get_connection_by_name(
            "head_tilt_joint"
        )
        r_shoulder_pan_joint: RevoluteConnection = god_map.world.get_connection_by_name(
            "r_shoulder_pan_joint"
        )
        l_shoulder_pan_joint: RevoluteConnection = god_map.world.get_connection_by_name(
            "l_shoulder_pan_joint"
        )
        r_shoulder_lift_joint: RevoluteConnection = (
            god_map.world.get_connection_by_name("r_shoulder_lift_joint")
        )
        l_shoulder_lift_joint: RevoluteConnection = (
            god_map.world.get_connection_by_name("l_shoulder_lift_joint")
        )
